...
- Local `bash scripts/build-apple-release.sh --all` 기준 Apple `1.0.3` build `4` iOS/macOS archive/export 및 `verify-appstore-archive.sh` 통과. 산출물은 `dist/export_ios/AgentDeck.ipa`, `dist/agentdeck-ios-v1.0.3.ipa`, `dist/export_macos/AgentDeck.pkg`.
